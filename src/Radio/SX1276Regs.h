...
#define SX127X_FROM_START_TRANSMIT_FIFO_LEVEL                                                                                                        \
    0b00011000 //  4     3                                                     transmit on a FIFO level interrupt
...
#define SX127X_FROM_RECEIVE_PACKET_RECEIVED_PAYLOAD                                                                                                  \
    0b00100000                                      //  7     5     mode that will be set after exiting receive mode: packet received on payload ready
                                                    //  interrupt (default)
#define SX127X_FROM_RECEIVE_LP_SELECTION 0b01000000 //  7     5                                                       low power selection
#define SX127X_FROM_RECEIVE_PACKET_RECEIVED_CRC_OK                                                                                                   \
    0b01100000 //  7     5                                                       packet received on CRC OK interrupt
#define SX127X_FROM_RECEIVE_SEQ_OFF_RSSI 0b10000000 //  7     5                                                       sequencer off on RSSI interrupt
#define SX127X_FROM_RECEIVE_SEQ_OFF_SYNC_ADDR                                                                                                        \
    0b10100000 //  7     5                                                       sequencer off on sync address interrupt
#define SX127X_FROM_RECEIVE_SEQ_OFF_PREAMBLE_DETECT                                                                                                  \
    0b11000000 //  7     5                                                       sequencer off on preamble detect
               //  interrupt
...
// SX1278_REG_AGC_REF
#define SX1278_AGC_REFERENCE_LEVEL_LF                                                                                                                \
    0x19 //  5     0     floor reference for AGC thresholds: AgcRef = -174 + 10*log(2*RxBw) + 8 + AGC_REFERENCE_LEVEL
         //  [dBm]: below 525 MHz
