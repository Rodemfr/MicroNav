...
uint8_t MicronetCodec::EncodeAlertMessage(MicronetMessage_t *message, uint8_t signalStrength, uint32_t networkId, uint32_t deviceId, uint8_t alertID)
{
    static uint8_t alertSeqNumber = 0x01;
    int offset = 0;
    ...
    message->data[offset++] = 0x00;
    // Data fields
    message->data[offset++] = 0xe2;
    message->data[offset++] = alertID;
    message->data[offset++] = alertSeqNumber++;
